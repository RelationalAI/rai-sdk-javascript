...
export declare class ModelApi extends TransactionApi {
    installModels(database: string, engine: string, models: Model[]): Promise<import("../transaction/types").TransactionResult>;
    listModels(database: string, engine: string): Promise<import("../transaction/types").TransactionResult>;
